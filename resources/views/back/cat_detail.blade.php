...
@section('content')
    ...
    <div class="col-md-9">
        <div class="cat-cont">
            <div class="well">
                <div class="row">
                    <div class="col-md-6">Delete this category</div>
                    <div class="col-md-6"><a href="/backend/delete_cat/{{ $catdetails->id }}" name="delete_cat" class="btn-sm btn-warning pull-right" onclick="confirm('Are you sure you want to delete this category?');">Delete Category</a></div>
                </div>
            </div>
            <form class="form-horizontal" method="post" action="/backend/categories/update/{{ $catdetails->id }}">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label">Set as Menu</label>
                    <div class="col-md-5">
                        <div class="checkbox">
                            <label>
                                <input name="menu_set" type="checkbox" value="Y" @if($catdetails->menu_set =="Y") checked="checked" @endif>
                            </label>
                        </div>
                    </div>
                </div>
